...
def develop_verbose():
    ...
    ...
    Develop: '/sample-buildout/foo'
    Keeping editable install of /sample-buildout/foo: its packaging metadata (setup.py, setup.cfg, pyproject.toml) is unchanged since the previous run
    Reusing editable install: /sample-buildout/develop-eggs/foo.egg-link
    ...
    ...
    test_suite = [
        ...
        doctest.DocFileSuite(
            ...
            checker=renormalizing.RENormalizing([
                ...
                zc.buildout.testing.normalize_endings,
                zc.buildout.testing.normalize_egg_py,
                zc.buildout.testing.drop_uv_link_server_requests,
